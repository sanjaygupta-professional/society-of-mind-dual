---
title: "Chapter 15: Consciousness and Memory"
description: "The relationship between conscious awareness and memory — how what we remember shapes what we experience as consciousness."
---
...
```mermaid
flowchart TB
    STM[Short-Term Memory] --> C[Consciousness]
    K[Active K-lines] --> STM
    SM[Self-Model] --> C
    C --> AW[Awareness]
    C --> R[Reflection]
    R --> SM
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Conscious Experience: STM + K-lines + Self-Model</p>
  <img src="/diagrams/ch15-consciousness-and-memory.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
