---
title: "Chapter 6: Insight and Introspection"
description: "Why we have limited access to our own mental processes, and what this reveals about the architecture of mind."
---
...
```mermaid
flowchart TB
    MP[Mental Processes] --> U[Unconscious Work]
    MP --> C[Conscious Report]
    U -->|hidden| R[Real Mechanisms]
    C -->|constructed| N[Narrative]
    N --> I[Illusion of Insight]
    R --> B[Actual Behavior]
```

<!-- beautiful-mermaid comparison -->
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Consciousness Gap: Unconscious Work vs Narrative Report</p>
  <img src="/diagrams/ch06-insight-and-introspection.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
