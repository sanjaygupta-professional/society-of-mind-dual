...
description: "Representations for understanding change, action, and transformation — how the mind tracks transitions between states."
---
...
```mermaid
flowchart LR
    B[Before State] --> T[Transformation]
    T --> A[After State]
    T --> AG[Agent of Change]
    T --> IN[Instrument]
    B --> D[Difference Detected]
    A --> D
    D --> T
```
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  ...
  <img src="/diagrams/ch21-trans-frames.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
