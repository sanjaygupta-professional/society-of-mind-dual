---
title: "Chapter 20: Context and Ambiguity"
description: "How the mind uses context to resolve the pervasive ambiguity of language and perception."
---
...
```mermaid
flowchart TB
    A[Ambiguous Input] --> C1[Context Agent 1]
    A --> C2[Context Agent 2]
    A --> C3[Context Agent 3]
    C1 --> I1[Interpretation A]
    C2 --> I1
    C3 --> I2[Interpretation B]
    I1 --> W[Winner: Most Support]
    I2 --> S[Suppressed]
```

<!-- beautiful-mermaid comparison -->
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Ambiguity Resolution: Context Agents → Winning Interpretation</p>
