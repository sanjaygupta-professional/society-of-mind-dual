---
title: "Chapter 22: Expression"
description: "How internal mental states get expressed through language, gesture, and behavior — the output side of the society of mind."
---
...
```mermaid
flowchart TB
    IS[Internal State] --> SEL[Selection Agents]
    SEL --> COMP[Compression Agents]
    COMP --> SEQ[Sequencing Agents]
    SEQ --> L[Language Output]
    SEQ --> G[Gesture Output]
    SEQ --> A[Action Output]
    IS --> GAP[Inexpressible Remainder]
```

<!-- beautiful-mermaid comparison -->
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Expression Pipeline: Thought → Selection → Communication</p>
  <img src="/diagrams/ch22-expression.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
