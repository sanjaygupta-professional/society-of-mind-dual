---
title: "Chapter 16: Emotion"
description: "Emotions as cognitive mechanisms — not opposites of thought but different ways of thinking that reshape the society of mind."
---
...
```mermaid
flowchart TB
    E[Emotion Trigger] --> RC[Reconfiguration]
    RC --> SA[Suppress Some Agents]
    RC --> AA[Amplify Other Agents]
    SA --> NM[New Mental State]
    AA --> NM
    NM --> NB[New Behavior]
    NM --> NP[New Perceptions]
    NM --> NG[New Goals]
```

<!-- beautiful-mermaid comparison -->
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Emotional Reconfiguration: Trigger → Agency Reordering</p>
  <img src="/diagrams/ch16-emotion.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
