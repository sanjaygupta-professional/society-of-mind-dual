---
title: "Chapter 10: Papert's Principle"
description: "The idea that some of the most powerful steps in mental growth come from acquiring new ways to manage what you already know."
---
...
```mermaid
flowchart TB
    SK[Existing Skills] --> MM[Meta-Management]
    MM --> NS[New Capability]
    SK --> |without management| F[Failure]
    P[Papert's Principle] --> MM
    MM --> O[Organization]
    MM --> S[Strategy Selection]
    O --> NS
    S --> NS
```
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  ...
  <img src="/diagrams/ch10-papert-principle.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
