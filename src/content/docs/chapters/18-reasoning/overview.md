...
description: "How the mind reasons through chains of agents — logical thinking as a specialized form of agent coordination."
---
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Reasoning Chain: Premise → Agent Links → Conclusion</p>
  <img src="/diagrams/ch18-reasoning.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
