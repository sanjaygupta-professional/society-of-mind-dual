---
title: "Chapter 13: Seeing and Believing"
description: "How perception is an active, constructive process shaped by expectations, beliefs, and prior knowledge."
---
...
```mermaid
flowchart TB
    S[Sensory Input] --> LL[Low-Level Agents]
    E[Expectations] --> HL[High-Level Agents]
    LL --> I[Integration]
    HL --> I
    I --> P[Perception]
    P --> B[Beliefs Updated]
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  ...
  <img src="/diagrams/ch13-seeing-and-believing.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
