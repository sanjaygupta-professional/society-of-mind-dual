---
title: "Chapter 2: Wholes and Parts"
description: "Exploring how the mind decomposes complex problems into manageable parts, and how wholes emerge from the interactions of those parts."
---
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Task Decomposition: Whole → Sub-problems → Agents</p>
  <img src="/diagrams/ch02-wholes-and-parts.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
