---
title: "Chapter 7: Problems and Goals"
description: "How the mind sets goals, decomposes problems, and manages the pursuit of multiple objectives simultaneously."
---
...
flowchart TB
    P[Problem] --> G1[Goal 1]
    P --> G2[Goal 2]
    G1 --> SP1[Sub-problem A]
    G1 --> SP2[Sub-problem B]
    G2 --> SP3[Sub-problem C]
    SP1 --> AG1[Agency 1]
    SP2 --> AG2[Agency 2]
    SP3 --> AG3[Agency 3]
    AG1 --> S[Solution]
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Problem Solving: Goals → Sub-problems → Agency Solution</p>
  <img src="/diagrams/ch07-problems-and-goals.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
