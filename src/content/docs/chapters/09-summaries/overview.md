---
title: "Chapter 9: Summaries"
description: "How the mind creates compressed representations and summaries of complex experiences to enable efficient thinking."
---
...
```mermaid
flowchart TB
    D[Detailed Experience] --> L1[Level 1 Summary]
    L1 --> L2[Level 2 Summary]
    L2 --> L3[Abstract Concept]
    D --> K[K-line Capture]
    K --> S[Selective Reactivation]
    S --> G[Generalization]
```

<!-- beautiful-mermaid comparison -->
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Hierarchical Abstraction: Detail → Summaries → Concepts</p>
  <img src="/diagrams/ch09-summaries.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
