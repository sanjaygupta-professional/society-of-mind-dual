...
description: "How minds grow and change over time — the stages of cognitive development seen through the society of mind framework."
---
...
```mermaid
flowchart TB
    I[Infancy: Proto-specialists] --> C[Childhood: Basic Agencies]
    C --> A[Adolescence: Meta-Agencies]
    A --> AD[Adulthood: Complex Societies]
    I --> PS[Proto-specialists Active]
    C --> NL[New Layers Added]
    A --> MK[Meta-Knowledge]
    AD --> FL[Full Layered Architecture]
```

<!-- beautiful-mermaid comparison -->
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Cognitive Development: Infancy → Adulthood Layered Build</p>
  <img src="/diagrams/ch17-development.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
