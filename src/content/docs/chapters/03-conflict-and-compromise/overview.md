---
title: "Chapter 3: Conflict and Compromise"
description: "How competing agents resolve disputes through negotiation, suppression, and compromise to produce coherent behavior."
---
...
```mermaid
flowchart TB
    G1[Goal: Play] --- C{Conflict}
    G2[Goal: Eat] --- C
    C --> N[Negotiation]
    N --> S[Suppression]
    N --> CM[Compromise]
    S --> W[Winner Acts]
    CM --> B[Blended Behavior]
```
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  ...
  <img src="/diagrams/ch03-conflict-and-compromise.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
