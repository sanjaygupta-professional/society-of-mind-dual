---
title: "Chapter 11: The Shape of Space"
description: "How the mind constructs internal representations of space and uses spatial reasoning as a foundation for abstract thought."
---
...
```mermaid
flowchart TB
    SR[Spatial Reasoning] --> PM[Physical Maps]
    SR --> AM[Abstract Maps]
    PM --> N[Navigation]
    PM --> O[Object Relations]
    AM --> CM[Concept Maps]
    AM --> MT[Metaphorical Thinking]
    N --> C[Coordination of Agents]
    O --> C
```

<!-- beautiful-mermaid comparison -->
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Spatial Reasoning: Maps → Navigation → Abstract Thinking</p>
  <img src="/diagrams/ch11-the-shape-of-space.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
