---
title: "Chapter 14: Reformulation"
description: "How the mind transforms problems by finding new representations that make difficult tasks easier to solve."
---
...
```mermaid
flowchart TB
    P[Problem in Form A] --> F[Failure]
    P --> RF[Reformulation]
    RF --> P2[Problem in Form B]
    P2 --> S[Solution Found]
    RF --> NR[New Representation]
    NR --> NA[New Agents Engaged]
    NA --> S
```
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  ...
  <img src="/diagrams/ch14-reformulation.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
