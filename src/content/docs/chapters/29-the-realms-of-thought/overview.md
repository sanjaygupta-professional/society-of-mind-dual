---
title: "Chapter 29: The Realms of Thought"
description: "Different modes of thinking — from concrete to abstract — and how the mind moves between them."
---
...
```mermaid
flowchart TB
    CT[Concrete Thought] --> AT[Abstract Thought]
    AT --> RT[Reflective Thought]
    CT --> PA[Physical Agents]
    AT --> SA[Symbolic Agents]
    RT --> MA[Meta-Agents]
    PA --> E[Experience]
    SA --> R[Reasoning]
    MA --> U[Understanding Understanding]
```

<!-- beautiful-mermaid comparison -->
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Thought Realms: Concrete → Abstract → Reflective</p>
  <img src="/diagrams/ch29-the-realms-of-thought.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
