---
title: "Chapter 4: The Self"
description: "Minsky challenges the idea of a single, unified self and proposes that what we call 'self' is a society of interacting processes."
---
...
```mermaid
flowchart TB
    S[The Self] --> SM[Self-Model]
    S --> SA[Self as Agent]
    S --> SI[Self as Illusion]
    SM --> R[Reflection]
    SM --> P[Prediction]
    SA --> C[Control]
    SI --> N[Narrative Construction]
```

<!-- beautiful-mermaid comparison -->
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Self-Model Construction: Reflection, Prediction, Control</p>
  <img src="/diagrams/ch04-the-self.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
