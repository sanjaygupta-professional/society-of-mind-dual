---
title: "Chapter 23: Comparisons"
description: "How the mind uses comparison as a fundamental operation — finding similarities, differences, and analogies between things."
---
...
```mermaid
flowchart TB
    A[Thing A] --> CA[Comparison Agents]
    B[Thing B] --> CA
    CA --> SIM[Similarities]
    CA --> DIF[Differences]
    CA --> AN[Analogies]
    SIM --> CL[Classification]
    DIF --> DI[Discrimination]
    AN --> TR[Transfer of Knowledge]
```

<!-- beautiful-mermaid comparison -->
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Comparison Operations: Similarity, Difference, Analogy</p>
  <img src="/diagrams/ch23-comparisons.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
