---
title: "Chapter 27: Censors and Jokes"
description: "How censors and suppressors regulate thought — and how humor arises from their temporary failure."
---
...
```mermaid
flowchart TB
    T[Thought Process] --> CE[Censor Check]
    CE -->|safe| C[Continue Thinking]
    CE -->|blocked| R[Redirect]
    J[Joke Setup] --> CE2[Censor Bypassed]
    CE2 --> SI[Suppressed Idea Revealed]
    SI --> L[Laughter]
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Mental Censoring: Thought Check → Allow/Redirect/Bypass</p>
