---
title: "Chapter 12: Learning Meaning"
description: "How minds attach meaning to experiences, words, and concepts through networks of agent connections."
---
...
```mermaid
flowchart TB
    W[Word: Apple] --> P[Polyneme]
    P --> C[Color Agency: Red]
    P --> S[Shape Agency: Round]
    P --> T[Taste Agency: Sweet]
    P --> M[Memory Agency: Experiences]
    C --> MN[Meaning]
    S --> MN
    T --> MN
    M --> MN
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  <p style="color: #7aa2f7; font-size: 0.85rem; margin-bottom: 0.75rem; font-weight: 500;">Polyneme Networks: Word → Multi-agency Activation</p>
  <img src="/diagrams/ch12-learning-meaning.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
