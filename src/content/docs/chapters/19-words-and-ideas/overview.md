---
title: "Chapter 19: Words and Ideas"
description: "The relationship between language and thought — how words serve as agents that activate networks of mental processes."
---
...
```mermaid
flowchart TB
    W[Word Agent] --> N1[Sensory Network]
    W --> N2[Motor Network]
    W --> N3[Emotional Network]
    W --> N4[Conceptual Network]
    N1 --> I[Idea]
    N2 --> I
    N3 --> I
    N4 --> I
    I --> NW[New Words Generated]
```
...
<div style="margin-top: 1.5rem; padding: 1rem; background: #1a1b26; border-radius: 8px;">
  ...
  <img src="/diagrams/ch19-words-and-ideas.svg" alt="Chapter diagram - tokyo-night theme" style="max-width: 100%; height: auto;" />
</div>
